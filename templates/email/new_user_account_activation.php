...
<body>
	...
	<div style="font-family: Calibri;">
		<span style="font-size: 22px;">Account Activation</span> <br /><br />
		<span style="font-size: 17px;">Please verify your email in order to use your account
		<br/><br/>
		
		Click on the link given below to confirm that you are the owner of this email and that you are the actual person who has initiated registration of an account</span>
		...
		<table style="border-collapse: collapse; ">
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid grey;padding: 10px; text-align: left;">{{verification_link}}</td>
                    </tr>			
		</table>
