...
var KTCustomersList = function () {
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll('[data-kt-table-filter="payment_type"] [name="payment_type"]');
    ...
    // Public methods
    return {
        init: function ( table_id_with_hash ) {
            if( table_id_with_hash != "" ){
                tableID = table_id_with_hash;
            }
